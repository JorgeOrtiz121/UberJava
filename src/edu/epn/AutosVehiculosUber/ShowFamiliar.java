 ...
 * clase VehiculoFamiliar
 */
public class ShowFamiliar {
    /**
     * Arraylist con los elementos de VehiculoFamiliar
     */
    static public  ArrayList<VehiculoFamiliar>family=new ArrayList<>();
    public static void Family(){
        ...
        do{
             ...
             */
            System.out.println("\n--------------Disponibilidad de Autos Familiares---------------");
            for (int i = 0; i < family.size(); i++) {
                int cont = i+1;
                System.out.println(cont + " " + family.get(i).getMarca() + "--" + family.get(i).getModelo() + "--" + family.get(i).isDisponible());
            }
            System.out.println("\n Ingrese su eleccion de coche, caso contrario ingrese o para salir");
            System.out.println("\n Selecciones su opcion");
            int desicion= Desiciones.Afirmardesicion(0,family.size());
            /**
            ...
            if(desicion>0){
                VehiculoFamiliar Seleccion=family.get(desicion-1);
